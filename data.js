...
module.exports = {
	...
	mobile : {
		...
		extra : [
			'a recognised license',
			'a film tie-in',
			'a TV tie-in',
			'augmented reality',
			'in-game currency',
			'a global high score table',
			'paid upgrades',
			'paid extra levels',
		...
		templates : [
			'{{#with mobile}} {{$ type article=true}} mobile {{$ genre}} where you {{$ input}} {{$ subject}} and {{$ input}} {{$ subject}} with {{$ extra}} {{/with}}',
			'{{#with mobile}} {{$ type article=true}} mobile {{$ genre}} where you {{$ input}} {{$ subject}} and {{$ action}} with {{$ extra}} {{/with}}',
			'{{#with mobile}} {{$ type article=true}} mobile {{$ genre}} where you {{$x2 input}} {{$ subject}} with {{$ extra}} {{/with}}',
		]
	}
